            ...
            <div className="flex-1 min-w-0">
              ...
              {toast.action && (
                <button
                  ...
                  className={`mt-2 text-xs px-3 py-1.5 rounded border transition-all font-semibold ${toast.type === 'error'
            ...
            <div className="flex items-center gap-1.5 mt-3 overflow-x-auto scrollbar-hide -mx-4 px-4 pb-1">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-2.5 py-1.5 rounded-full text-xs font-semibold transition-all whitespace-nowrap flex-shrink-0 active:scale-95 ${filter === f.id
        ...
        <div className="p-4 border-b border-zinc-700 flex-shrink-0 bg-zinc-900/50">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`text-xs px-2 py-1 rounded border transition-all ${groupByTime ? 'bg-blue-600/20 text-blue-400 border-blue-500/30' : 'bg-zinc-800 text-zinc-400 border-zinc-700'
                }`}
            ...
            <button
              ...
              className={`text-xs px-2 py-1 rounded border transition-all ${groupByType ? 'bg-amber-600/20 text-amber-400 border-amber-500/30' : 'bg-zinc-800 text-zinc-400 border-zinc-700'
                }`}
        ...
        <div className="px-4 pb-3 border-b border-zinc-700/50 flex-shrink-0">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'all'
            ...
            <button
              ...
              className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'toast'
            ...
            <button
              ...
              className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'log'
          ...
          {['all', 'toast', 'success', 'error', 'warning', 'info'].includes(filter) ? (
            <div className="flex flex-wrap gap-2 mt-2">
              <button
                onClick={() => setFilter('success')}
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'success'
              ...
              <button
                ...
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'error'
              ...
              <button
                ...
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'warning'
                  ? 'bg-amber-600/20 text-amber-400 border-amber-500/30'
                  : 'bg-zinc-800 text-zinc-400 border-zinc-700 hover:border-zinc-600'
                  }`}
              >
              ...
              <button
                ...
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'info'
                  ? 'bg-blue-600/20 text-blue-400 border-blue-500/30'
                  : 'bg-zinc-800 text-zinc-400 border-zinc-700 hover:border-zinc-600'
                  }`}
              >
          ...
          {['all', 'log', 'logic', 'discovery', 'update', 'fate'].includes(filter) ? (
            <div className="flex flex-wrap gap-2 mt-2">
              <button
                onClick={() => setFilter('logic')}
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'logic'
              ...
              <button
                ...
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'discovery'
                  ? 'bg-amber-600/20 text-amber-400 border-amber-500/30'
                  : 'bg-zinc-800 text-zinc-400 border-zinc-700 hover:border-zinc-600'
                  }`}
              >
              ...
              <button
                ...
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'update'
                  ? 'bg-blue-600/20 text-blue-400 border-blue-500/30'
                  : 'bg-zinc-800 text-zinc-400 border-zinc-700 hover:border-zinc-600'
                  }`}
              >
              ...
              <button
                ...
                className={`text-xs px-2 py-1 rounded border transition-all ${filter === 'fate'
                  ? 'bg-purple-600/20 text-purple-400 border-purple-500/30'
                  : 'bg-zinc-800 text-zinc-400 border-zinc-700 hover:border-zinc-600'
                  }`}
              >
